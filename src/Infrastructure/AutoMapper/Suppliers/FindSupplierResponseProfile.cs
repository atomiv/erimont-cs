...
{
    public class FindSupplierResponseProfile : ResponseProfile<Supplier, FindSupplierResponse>
    {
        // TODO: VC: Consider shared dtos for responses, esp. if on frontend there is the model

        protected override void Extend(IMappingExpression<Supplier, FindSupplierResponse> map)
        {
